...
<template>
  <div class="w-5/6 xl:w-4/6 m-auto py-14">
    <div
      class="card lg:card-side bg-[#ffffff1a] border-[#d3d3d333] p-4 sm:p-6 flex justify-center items-center"
    >
      <div class="card-body w-full lg:w-3/5 xl:w-2/3 p-4 sm:px-8 py-20 gap-5">
        <h2
          ref="title1"
          class="card-title text-2xl sm:text-4xl my-2 bg-linear-to-r from-[#36D1DC] to-[#5B86E5] text-transparent bg-clip-text"
        >
        ...
        <h2
          ref="title2"
          class="card-title justify-end text-2xl sm:text-4xl my-2 bg-linear-to-r from-[#fc00ff] to-[#00dbde] text-transparent bg-clip-text"
        >
